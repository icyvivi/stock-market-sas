...
# Page title
st.set_page_config(page_title='ML model builder',layout="wide", initial_sidebar_state="expanded", page_icon='🏗️')
st.title('🏗️ ML model builder')

st.sidebar.write('''# SAS ''')
with st.sidebar: 
        selected = option_menu("ML", ["Stocks Performance Comparison", "Real-Time Stock Price", "Stock Prediction", 'About'])
...
with st.expander('About this app'):
  ...
  st.code('''- OHLCV from Yahoo Finance
  ''', language='markdown')
  
  st.markdown('Some Libraries used:')
